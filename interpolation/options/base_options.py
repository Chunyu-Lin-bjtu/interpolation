...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--model', type=str, default='', help='which model to use')
        self.parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization')        
        self.parser.add_argument('--use_dropout', action='store_true', help='use dropout for the generator')
	#where the model stored and where to load pretrain model
        ...
        self.parser.add_argument('--load_pretrain', type=str, default='./checkpoints/label2city_512p/', help='load the pretrained model from the specified location')

        # input/output sizes       
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=512, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=512, help='then crop to this size')
        self.parser.add_argument('--fixedWidth', type=int, default=1920, help='fix images width to this size')
        self.parser.add_argument('--fixedHeight', type=int, default=1280, help='fix images height to this size')
    ...
    def parse(self, save=True):
        ...
        self.opt.continue_train = self.continue_train   # train or test
        self.opt.isTest = self.isTest   # train or test
