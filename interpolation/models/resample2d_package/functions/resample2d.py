...
class ForwardResample2dFunction(Function):
    ...
    def forward(ctx, input1, input2, kernel_size=1):
        ...
        resample2d.ForwardResample2d_cuda_forward(input1, input2, output, kernel_size)
    ...
    def backward(ctx, grad_output):
        ...
        resample2d.ForwardResample2d_cuda_backward(input1, input2, grad_output.data,
                                            grad_input1.data, grad_input2.data,
                                            ctx.kernel_size)
